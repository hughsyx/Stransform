clear cc_05_16_filt_5_tmp
Day = [77,78,79,80,81,82,83,84,85];
for iday = 1:length(Day)
    day = Day(iday)
cc_05_16_filt_5 = zeros(1,7999);
for iwin = 1:96
%     ST04 = stran_my(C1_A01_80_filt(18000+8000:18000+12000-1,iwin,4)',0.05);
%     ST05 = stran_my(C1_A01_80_filt(18000+8000:18000+12000-1,iwin,5)',0.05);
%     ST06 = stran_my(C1_A01_80_filt(18000+8000:18000+12000-1,iwin,6)',0.05);
%     ST07 = stran_my(C1_A01_80_filt(18000+8000:18000+12000-1,iwin,7)',0.05);
%     ST08 = stran_my(C1_A01_80_filt(18000+8000:18000+12000-1,iwin,8)',0.05);
%     ST09 = stran_my(C1_A01_80_filt(18000+8000:18000+12000-1,iwin,9)',0.05);
%     ST10 = stran_my(C1_A01_80_filt(18000+8000:18000+12000-1,iwin,10)',0.05);
%     ST11 = stran_my(C1_A01_80_filt(18000+8000:18000+12000-1,iwin,11)',0.05);
%     ST12 = stran_my(C1_A01_80_filt(18000+8000:18000+12000-1,iwin,12)',0.05);
%     ST13 = stran_my(C1_A01_80_filt(18000+8000:18000+12000-1,iwin,13)',0.05);
%     ST14 = stran_my(C1_A01_80_filt(18000+8000:18000+12000-1,iwin,14)',0.05);
%     ST15 = stran_my(C1_A01_80_filt(18000+8000:18000+12000-1,iwin,15)',0.05);
%     ST16 = stran_my(C1_A01_80_filt(18000+8000:18000+12000-1,iwin,16)',0.05);
%     ST17 = stran_my(C1_A01_80_filt(18000+8000:18000+12000-1,iwin,17)',0.05);
    ST04 = stran_my(eval(['C1_A01_',num2str(day),'_filt(18000+8000:18000+12000-1,iwin,4)'])',0.05);
    ST05 = stran_my(eval(['C1_A01_',num2str(day),'_filt(18000+8000:18000+12000-1,iwin,5)'])',0.05);
    ST06 = stran_my(eval(['C1_A01_',num2str(day),'_filt(18000+8000:18000+12000-1,iwin,6)'])',0.05);
    ST07 = stran_my(eval(['C1_A01_',num2str(day),'_filt(18000+8000:18000+12000-1,iwin,7)'])',0.05);
    ST08 = stran_my(eval(['C1_A01_',num2str(day),'_filt(18000+8000:18000+12000-1,iwin,8)'])',0.05);
    ST09 = stran_my(eval(['C1_A01_',num2str(day),'_filt(18000+8000:18000+12000-1,iwin,9)'])',0.05);
    ST10 = stran_my(eval(['C1_A01_',num2str(day),'_filt(18000+8000:18000+12000-1,iwin,10)'])',0.05);
    ST11 = stran_my(eval(['C1_A01_',num2str(day),'_filt(18000+8000:18000+12000-1,iwin,11)'])',0.05);
    ST12 = stran_my(eval(['C1_A01_',num2str(day),'_filt(18000+8000:18000+12000-1,iwin,12)'])',0.05);
    ST13 = stran_my(eval(['C1_A01_',num2str(day),'_filt(18000+8000:18000+12000-1,iwin,13)'])',0.05);
    ST14 = stran_my(eval(['C1_A01_',num2str(day),'_filt(18000+8000:18000+12000-1,iwin,14)'])',0.05);
    ST15 = stran_my(eval(['C1_A01_',num2str(day),'_filt(18000+8000:18000+12000-1,iwin,15)'])',0.05);
    ST16 = stran_my(eval(['C1_A01_',num2str(day),'_filt(18000+8000:18000+12000-1,iwin,16)'])',0.05);
    ST17 = stran_my(eval(['C1_A01_',num2str(day),'_filt(18000+8000:18000+12000-1,iwin,17)'])',0.05);
    ...
    d16 = distance(latlon(16,1),latlon(16,2),latlon(4:17,1),latlon(4:17,2),almanac('earth','ellipsoid'));
    for i=1:length(s)
        for j=1:length(d05)
            delta(i,j) = d05(j)*s(i);
        end
    ...
    c5_5 = c5.^5;
    c5_5 = c5_5/max(max(abs(c5_5)));
    ST16_filt_5 = ST16.*c5_5;
    C1_A01_16_filt_5 = inv_stran_my(ST16_filt_5,0.05);
    
    clear c1 c2 c3 c4 c5 c5_5 ST04 ST05 ST06 ST07 ST08 ST09 ST10 ST11 ST12 ST13 ST14 ST15 ST16 ST17 Phi*
    cc_05_16_filt_5 = cc_05_16_filt_5 + real(ifftshift(ifft(fft(C1_A01_16_filt_5,7999).*conj(fft(C1_A01_05_filt_5,7999)))));
end
cc_05_16_filt_5_tmp(iday,:) = cc_05_16_filt_5;
end